...
public abstract class ExpressionImpl implements Expression {
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || !(o instanceof Expression))
      return false;
    if (o instanceof Constant && !(this instanceof Constant))
      return false;
    if (this instanceof Constant && !(o instanceof Constant))
      return false;

    Expression that = (Expression) o;

    if (returnType != null ? !returnType.equals(that.getType()) : that.getType() != null)
      return false;
    if (!sameExpression(that)) {
      return false;
    }
